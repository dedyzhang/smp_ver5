...
@section('container')
    {{Breadcrumbs::render('jadwal-versi-waktu-edit',$uuid,$waktuJadwal)}}
    <div class="body-contain-customize col-12">
        <h5><b>Edit Waktu</b></h5>
        <p>Mengedit Waktu dalam Jadwal Pelajaran</p>
    </div>
    <div class="body-contain-customize col-12 mt-3">
        @if (session('success'))
            <div class="alert alert-success alert-dismissible fade show d-flex align-content-between align-items-center mt-3" role="alert">
                ...
                <div>
                    <strong>Sukses !</strong> Mengedit Waktu Di Jadwal
                </div>
        ...
        @endif
        <form action="{{route('jadwal.waktu.update',['uuid' => $uuid,'waktuUUID' => $waktuJadwal->uuid])}}" method="POST">
            @csrf
            @method('put')
            <div class="row m-0 p-0">
                <div class="form-group col-12 col-sm-12 col-md-8 col-lg-8 col-xl-8">
                    <label for="waktu_mulai">Waktu Mulai</label>
                    <input type="time" name="waktu_mulai" id="waktu_mulai" class="form-control @error('waktu_mulai') is-invalid @enderror" value="{{old('waktu_mulai',$waktuJadwal->waktu_mulai)}}" placeholder="Masukkan Waktu Mulai Jadwal">
                    @error('waktu_mulai')
                ...
                <div class="form-group col-12 col-sm-12 col-md-8 col-lg-8 col-xl-8 mt-3">
                    ...
                    <input type="time" name="waktu_akhir" id="waktu_akhir" class="form-control @error('waktu_akhir') is-invalid @enderror" value="{{old('waktu_akhir',$waktuJadwal->waktu_akhir)}}" placeholder="Masukkan Waktu Akhir Jadwal">
                    @error('waktu_akhir')
