...
<div class="body-contain-customize col-12">
    <h5><b>Classroom</b></h5>
    <p>Halaman ini digunakan guru untuk membuat materi pembelajaran maupun mengupload file pembelajaran yang akan
        diakses oleh siswa bersangkutan</p>
</div>
    ...
    <div class="card border-light rounded-4">
        <div class="card-body">
            ...
            <div class="button-place mt-3">
                <a href="{{ route('classroom.show',$ngajar->uuid) }}"
