...
@section('container')
    {{ Breadcrumbs::render('p3-edit',$p3); }}
    <div class="col-12 body-contain-customize">
        <h5>Pelanggaran, Prestasi dan Partisipasi</h5>
        <p>Halaman ini diperuntukkan admin dan Wakil Kesiswaan untuk Mengedit Pelanggaran, Prestasi dan Partisipasi yang akan dipilih oleh guru bersangkutan</p>
    </div>
    ...
    <div class="col-12 body-contain-customize mt-3">
        <p class="fs-12"><b>Form Edit P3 ( Pelanggaran, Prestasi dan Partisipasi )</b></p>
        <div class="row m-0 p-0">
            <form action="{{route('p3.update',$p3->uuid)}}" method="post">
                @method('put')
                @csrf
                <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6 form-group m-0 p-0">
                    ...
                    <select name="jenis" id="jenis" class="form-select @error('jenis') is-invalid @enderror">
                        ...
                        <option {{old('jenis',$p3->jenis) == "pelanggaran" ? "selected" : "" }} value="pelanggaran">Pelanggaran</option>
                        <option {{old('jenis',$p3->jenis) == "prestasi" ? "selected" : "" }} value="prestasi">Prestasi</option>
                        <option {{old('jenis',$p3->jenis) == "partisipasi" ? "selected" : "" }} value="partisipasi">Partisipasi</option>
                    </select>
                    @error('jenis')
                ...
                <div class="col-12 col-sm-12 col-md-12 col-lg-10 col-xl-10 form-group m-0 p-0">
                    ...
                    <input type="text" name="deskripsi" id="deskripsi" placeholder="Masukkan Deskripsi" class="form-control @error('deskripsi') is-invalid @enderror" value="{{old('deskripsi',$p3->deskripsi)}}" />
                    @error('deskripsi')
                        <div class="invalid-feedback">
