    ...
    <div class="body-contain-customize col-12 mt-3">
        ...
        <div class="row m-0 p-0">
            <div class="m-0 p-0 mt-2 col-12 col-sm-12 col-md-10 col-lg-4 col-xl-4 form-group">
                ...
                <input type="date" class="form-control" name="tanggal" id="tanggal" placeholder="Tanggal Penambahan P3" value="{{ old('tanggal') }}" />
            </div>
            ...
            <div class="m-0 p-0 mt-2 col-12 col-sm-12 col-md-10 col-lg-6 col-xl-6 form-group">
                ...
                <select class="form-control" name="jenis" id="jenis" placeholder="Jenis Penambahan p3" >
            ...
            <div class="m-0 p-0 mt-2 col-12 col-sm-12 col-md-12 col-lg-10 col-xl-10 form-group">
                ...
                <textarea class="form-control" name="deskripsi" id="deskripsi" placeholder="Deskripsi Poin P3" value="{{ old('deskripsi') }}"></textarea>
            </div>
            <div class="button-place m-0 p-0 mt-3">
                <button class="btn btn-warning text-warning-emphasis btn-sm">
