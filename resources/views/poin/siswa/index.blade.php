...
@section('container')
    ...
    <div class="body-contain-customize col-12">
        ...
        <p>Halaman ini berguna untuk melihat sisa poin siswa dan mengedit poin siswa</p>
    </div>
            ...
            <tbody>
                @foreach ($siswa as $item)
                    <tr>
                        ...
                        <td>
                            <a href="{{route('poin.show',$item->uuid)}}" class="btn btn-sm btn-warning text-warning-emphasis">
