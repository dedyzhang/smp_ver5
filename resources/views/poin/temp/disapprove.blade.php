...
@section('container')
    {{Breadcrumbs::render('pengajuan-poin-disapprove')}}
    <div class="body-contain-customize col-12">
        <h5><b>Disapprove Poin</b></h5>
        <p>Halaman ini untuk menampilkan poin yang sudah di disapprove oleh waka kesiswaan</p>
    </div>
