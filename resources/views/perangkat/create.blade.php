...
@section('container')
    {{Breadcrumbs::render('perangkat-create')}}
    ...
    <div class="body-contain-customize col-12 mt-3">
        ...
        <form method="post" action="">
            ...
            <div class="form-group col-10">
                ...
                <input type="text" class="form-control @error('perangkat') is-invalid @enderror" name="perangkat" id="perangkat" value="{{old('perangkat')}}" placeholder="Masukkan Nama Perangkat">
