...
@section('container')
    ...
    <div class="body-contain-customize col-12">
        <h5><b>Cetak Nilai P5</b></h5>
        <p>Halaman Admin untuk mencetak Nilai P5 Siswa</p>
    </div>
            ...
            <tbody>
                @foreach ($kelas as $item)
                    <tr>
                        ...
                        <td><a href="{{route('cetak.proyek.excel',$item->uuid)}}" class="btn btn-sm btn-warning text-warning-emphasis"><i class="fa-regular fa-file-excel"></i></a></td>
                    </tr>
                @endforeach
            </tbody>
        </table>
