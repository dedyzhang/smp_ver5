...
@section('container')
    {{Breadcrumbs::render('cetak-pts')}}
    <div class="body-contain-customize col-12">
        <h5><b>Cetak Nilai PTS</b></h5>
        <p>Halaman Admin untuk mencetak Nilai Tengah Semester Siswa</p>
    </div>
            ...
            <tbody>
                @foreach ($kelas as $item)
                    <tr>
                        ...
                        <td><a href="{{route('cetak.pts.excel',$item->uuid)}}" class="btn btn-sm btn-warning text-warning-emphasis"><i class="fa-regular fa-file-excel"></i></a></td>
                    </tr>
                @endforeach
            </tbody>
        </table>
