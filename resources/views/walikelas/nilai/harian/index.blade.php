...
@section('container')
    {{Breadcrumbs::render('walikelas-nilai-harian')}}
                    ...
                    if(data.success) {
                        ...
                        pelajaran.forEach(item => {
                            if(item.pelajaran.has_penjabaran == 1 || item.pelajaran.has_penjabaran == 2) {
                                ...
                                <a href="{{route('walikelas.nilai.sumatif',':id')}}" class="list-group-item list-group-item-action">Nilai Sumatif</a>
                                <a href="{{route('walikelas.nilai.penjabaran',':id')}}" class="list-group-item list-group-item-action">Nilai Penjabaran</a>
                                `;
                            } else {
                                var link = `
                                <a href="{{route('walikelas.nilai.materi',':id')}}" class="list-group-item list-group-item-action">Materi</a>
