...
@section('container')
    {{Breadcrumbs::render('walikelas-classroom-show',$ngajar->pelajaran, $ngajar->kelas,$ngajar)}}
    <div class="body-contain-customize col-12">
        <h5><b>Classroom</b></h5>
        <p>Halaman ini diperuntukkan walikelas untuk memantau Pembelajaran dikelas</p>
    </div>
                            ...
                            <div>
                                ...
                                <div class="mt-3">
                                    ...
                                    <div class="button-place mt-3 gap-2 d-grid d-sm-grid d-md-flex d-xl-flex d-lg-flex">
                                        <a href="{{route('walikelas.classroom.preview',['uuid' => $ngajar->uuid,'uuidClassroom' => $item->uuid])}}" class="btn btn-sm btn-warning text-warning-emphasis">
