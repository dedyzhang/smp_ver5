...
<div class="body-contain-customize col-12 mt-3">
        ...
        <table class="table table-bordered table-hover fs-12">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{$ngjr->pelajaran}}</td>
                    <td>{{$ngjr->tingkat.$ngjr->kelas}}</td>
                    <td
                        contenteditable="true"
                        style="cursor: text"
                        class="kktp"
                        data-ngajar="{{$ngjr->uuid}}"
                    >
                        {{$ngjr->kkm}}
                    </td>
                </tr>
    ...
    <div
        class="button-place mt-3 d-grid d-sm-grid d-md-flex d-lg-flex d-xl-flex justify-content-lg-end justify-content-md-end justify-content-xl-end"
    >
        <button
            class="btn btn-sm btn-warning text-warning-emphasis simpan-kktp"
        >
            <i class="fas fa-save"></i> Simpan KKTP
        </button>
    </div>
</div>
<script>
    ...
    $(".simpan-kktp").click(function () {
        ...
        cConfirm(
            "Perhatian",
            "Yakin untuk simpan data KKTP sesuai yang diinput",
            simpanKKTP
        );
    });
</script>
