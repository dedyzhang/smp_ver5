@extends('layouts.main') @section('container')
    ...
    <div class="body-contain-customize col-12">
        ...
        <p>
            raport adalah laporan penilaian yang digunakan untuk melaporkan hasil
            belajar siswa dengan menekankan pada sejauh mana peserta didik mampu
            ...
            <div class="card border-light rounded-4">
                <div class="card-body">
                    ...
                    <div class="button-place mt-3">
                        <a href="{{ route('penilaian.rapor.show', $ngajar->uuid) }}"
                            class="btn btn-sm btn-warning text-warning-emphasis" data-bs-toggle="tooltip"
                            data-bs-title="Lihat Rapor" data-bs-placement="top"><i class="fas fa-eye"></i></a>
                    </div>
                </div>
            </div>
        </div>
