...
{{Breadcrumbs::render('penilaian-formatif')}}
<div class="body-contain-customize col-12">
    <h5 class="m-0 mb-1"><b>Formatif</b></h5>
    <p>
        Penilaian formatif adalah proses memantau dan menilai pembelajaran dan
        pemahaman siswa selama proses belajar berlangsung. Tujuan dari penilaian
        formatif adalah mengetahui perkembangan penguasaan siswa terhadap suatu
        unit/bab/kompetensi yang sedang dipelajari.
    </p>
</div>
    ...
    <div class="card border-light rounded-4">
        <div class="card-body">
            ...
            <div class="button-place mt-3">
                <a
                    href="{{route('penilaian.formatif.show',$ngajar->uuid)}}"
                    class="btn btn-sm btn-warning text-warning-emphasis"
                    data-bs-toggle="tooltip"
                    data-bs-title="Lihat Formatif"
