@extends('layouts.main') @section('container')
    ...
    <div class="body-contain-customize col-12">
        ...
        <p>
            Materi penting yang harus dikuasai oleh siswa dan merupakan materi yang
            berkelanjutan yang terdapat pada semua jenjang kelas.
        </p>
    </div>
            ...
            <div class="card border-light rounded-4">
                <div class="card-body">
                    ...
                    <div class="button-place mt-3">
                        <a href="{{ route('penilaian.materi.show', $ngajar->uuid) }}"
                            class="btn btn-sm btn-warning text-warning-emphasis" data-bs-toggle="tooltip"
                            data-bs-title="Lihat materi" data-bs-placement="top"><i class="fas fa-eye"></i></a>
                    </div>
                </div>
            </div>
        </div>
