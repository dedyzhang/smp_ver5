...
@section('container')
    {{ Breadcrumbs::render('penilaian-admin-rapor') }}
    <div class="body-contain-customize col-12">
        <h5><b>Penilaian Raport</b></h5>
        <p>Halaman ini berisi data penilaian Rapor yang sudah dikonfirmasi oleh guru pada masa semester
            tahun
            ...
            <div class="card border-light rounded-4" data-uuid="{{ $kls->uuid }}">
                <div class="card-body">
                    ...
                    <div class="button-place mt-5 d-flex justify-content-end">
                        <a href="{{ route('penilaian.admin.rapor.showAll', $kls->uuid) }}"
