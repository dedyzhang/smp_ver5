...
@section('container')
    ...
    <div class="body-contain-customize col-12">
        ...
        <p>Penilaian Tengah Semester adalah evaluasi yang dilakukan untuk mengukur pencapaian hasil belajar siswa selama setengah semester. PTS merupakan salah satu alat penting untuk memastikan bahwa standar pendidikan yang ditetapkan oleh sekolah tetap tercapai.</p>
    </div>
            ...
            <div class="card border-light rounded-4">
                <div class="card-body">
                    ...
                    <div class="button-place mt-3">
                        <a href="{{route('penilaian.pts.show',$ngajar->uuid)}}" class="btn btn-sm btn-warning text-warning-emphasis" data-bs-toggle="tooltip" data-bs-title="Lihat Formatif" data-bs-placement="top"><i class="fas fa-eye"></i></a>
                    </div>
                </div>
            </div>
        </div>
