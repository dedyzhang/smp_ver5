            ...
            <div class="card border-light rounded-4">
                <div class="card-body">
                    ...
                    <div class="button-place mt-3">
                        <a href="{{route('penilaian.sumatif.show',$ngajar->uuid)}}" class="btn btn-sm btn-warning text-warning-emphasis" data-bs-toggle="tooltip" data-bs-title="Lihat Sumatif" data-bs-placement="top"><i class="fas fa-eye"></i></a>
                    </div>
                </div>
            </div>
        </div>
