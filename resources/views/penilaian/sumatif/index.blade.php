...
@section('container')
    ...
    <div class="body-contain-customize col-12">
        ...
        <p>Penilaian Sumatif adalah sebuah penilaian yang bertujuan untuk menilai pencapaian tujuan pembelajaran dan/atau Capaian Pembelajaran (CP) murid, sebagai dasar penentuan kenaikan kelas dan/atau kelulusan dari satuan pendidikan.</p>
    </div>
            ...
            <div class="card border-light rounded-4">
                <div class="card-body">
                    ...
                    <div class="button-place mt-3">
                        <a href="{{route('penilaian.sumatif.show',$ngajar->uuid)}}" class="btn btn-sm btn-warning text-warning-emphasis" data-bs-toggle="tooltip" data-bs-title="Lihat Formatif" data-bs-placement="top"><i class="fas fa-eye"></i></a>
                    </div>
                </div>
            </div>
        </div>
