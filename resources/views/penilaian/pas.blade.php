...
@section('container')
    {{ Breadcrumbs::render('penilaian-admin-pas') }}
    <div class="body-contain-customize col-12">
        <h5><b>Penilaian PAS/T</b></h5>
        <p>Halaman ini berisi data penilaian Akhir Semester / Tahun Per kelas yang diinput oleh guru pada masa semester
            tahun
            pelajaran berjalan</p>
    </div>
            ...
            <div class="card border-light rounded-4" data-uuid="{{ $kls->uuid }}">
                <div class="card-body">
                    ...
                    <div class="button-place mt-5 d-flex justify-content-end">
                        <a href="{{ route('penilaian.admin.pas.showAll', $kls->uuid) }}"
